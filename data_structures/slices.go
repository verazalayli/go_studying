...
// Слайсы в Go — это динамические структуры данных с переменной длиной и емкостью.
// Они позволяют:
// - Динамически изменять размер данных (добавлять, удалять элементы)
// - Работать с частями данных (срезами)
// - Передавать данные по ссылке (экономия памяти)
// - Реализовывать структуры данных (например, стек, очередь)
// - Удобно работать с коллекциями и алгоритмами сортировки
// - Использовать слайсы для манипуляции текстом и байтами
